...
local function InitCircle(offsetx,offsety,noblur)
    ...
    CreateThread(function()
        ...
        AddReplaceTexture("platform:/textures/graphics", "radarmasksm", "nbk_radarmasksm_full", noblur and 'radarmasksm_circle_noblur' or "radarmasksm_circle_noblur")
...
local function GetMinimapAnchor(offsetx,offsety,k1,k2) --https://forum.cfx.re/t/release-utility-minimap-anchor-script/81912
    ...
    Minimap.left_x, Minimap.top_y = GetScriptGfxPosition(minimap_main.posX+offsetx+0.0042, (minimap_main.posY + (-minimap_main.sizeY))* (isCircleMode and 1.33 or 1.00) + offsety )
